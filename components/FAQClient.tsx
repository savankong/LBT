...
const FAQS = [
  ...
  { q: 'Who is the show for?', a: "Anyone who has experienced a layoff, career pivot, burnout, or significant identity shift tied to their work. And anyone who is curious about what other people's careers actually look like from the inside." },
