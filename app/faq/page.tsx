...
const jsonLd = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'Who is the Life Between Titles podcast for?', acceptedAnswer: { '@type': 'Answer', text: 'Anyone who has experienced a layoff, career pivot, burnout, or significant identity shift tied to their work. Also anyone curious about what other people\'s careers actually look like from the inside.' } },
