...
const SHOWS = [
  {
    ...
    episodes: [
      ...
      {
        title: 'Savan Kong — From Corporate to Podcaster',
        guest: 'Savan Kong',
  ...
  },
  {
    ...
    episodes: [
      {
        title: 'Lt. Gen. (Ret) Matthew "Jerry" Glavy — S2E3',
      ...
      {
        title: 'Dr. Jordan Swanson — Pediatric Craniofacial Surgeon — S2E2',
      ...
      {
        title: 'Aaron Brooks — Federal Bureau of Prisons Food Service Supervisor',
        guest: 'Aaron Brooks',
    ...
    <>
      <section className="page-header">
        <div className="container">
          <div className="page-header-inner">
            ...
            <h1>The Shows</h1>
            <p>
              Some career advice is built for people who already know where they&apos;re going. This is for everyone else.
            </p>
          </div>
        </div>
      </section>
      ...
      {SHOWS.map((show, i) => (
        <div key={show.id}>
          ...
          <section className="section" id={show.id}>
            <div className="container">
              <div style={{ maxWidth: '680px', marginBottom: '56px' }}>
                <span className="label">{show.tag}</span>
                <h2 style={{ marginBottom: '16px' }}>{show.title}</h2>
              ...
              {show.episodes.length > 0 ? (
                <>
                  <span className="label" style={{ marginBottom: '24px' }}>Episodes</span>
                ...
                <div className="glass" style={{ borderRadius: '16px', padding: '48px', textAlign: 'center', maxWidth: '500px' }}>
                  <p style={{ fontSize: '0.95rem', marginBottom: '20px' }}>Episodes coming soon. Subscribe to stay in the loop.</p>
